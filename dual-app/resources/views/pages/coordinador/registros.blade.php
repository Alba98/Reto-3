            ...
            <div class="col col-md-5">
                <div class="card border-3 border-primary p-3">
                  <div class="card-body">
                    ...
                    <a href="#" class="btn btn-primary fs-5">Ver datos tutores universidad <i class="bi bi-plus-circle"></i></a>
                  </div>
                </div>
              </div>
          <div class="col col-md-5">
            <div class="card border-3 border-primary p-3">
              <div class="card-body">
                ...
                <a href="#" class="btn btn-primary fs-5">Ver datos alumnos <i class="bi bi-plus-circle"></i></a>
              </div>
            </div>
          </div>
        </div>
          ...
          <div class="col col-md-5">
            <div class="card  border-3 border-primary p-3">
              <div class="card-body">
                ...
                <a href="#" class="btn btn-primary fs-5">Ver empresas <i class="bi bi-plus-circle"></i></a>
              </div>
            </div>
          </div>
          <div class="col col-md-5">
            <div class="card border-3 border-primary p-3">
              <div class="card-body">
                ...
                <a href="#" class="btn btn-primary fs-5">Ver coordinadores <i class="bi bi-plus-circle"></i></a>
              </div>
            </div>
          </div>
        </div>
