...
<div class="container">
    <div class="row justify-content-center">
        <div class="col-md-8">
            <h1 class="display-3 text-center">Dar de alta tutor universidad</h1>
            <div class="card">
                <div class="card-header">{{ __('Nuevo tutor de la universidad') }}</div>
                <div class="card-body">
                    <form method="POST" action="{{ route('tuniversidad.store') }}" id="tUniForm">
                        @csrf
                        <div class="row mb-3">
                        ...
                        <div class="row mb-0">
                            <div class="col-md-8 offset-md-4">
                                <button type="submit" class="btn btn-primary" id="darAltaTuni">
                                    {{ __('Guardar') }}
                                </button>
                            </div>
                        </div>
